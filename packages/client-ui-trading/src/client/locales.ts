...
export const zh: Record<MarketLocaleKey, string> = {
      ...
      'sidebar.add': '添加',
      'sidebar.addMarketHint': '点击切换目标市场（加密货币→美股→A股→港股→期货）',
      'sidebar.empty': '暂无标的',
      ...
      'row.select': '查看行情',
      'row.group': '分组',
      'group.menu.aria': '自选分组',
      'group.all': '全部',
      'group.create': '创建分组',
      'group.createPlaceholder': '输入分组名称，回车确认',
      'group.manage': '自选管理',
      'group.emptyHint': '该分组暂无标的——在上方添加代码，或在「自选管理」中归类',
      'group.duplicateName': '分组名称已存在',
      'group.notFound': '分组已不存在（可能已被删除）',
      'group.createFailed': '操作失败——宿主桥不可用，本地未改动',
      'group.ungrouped': '未分组',
      'group.remove': '移出分组',
      'group.noneHint': '还没有分组——先在标题菜单「创建分组」',
      'manager.title': '自选管理',
      'manager.close': '关闭',
      'manager.cancel': '取消',
      'manager.ok': '确定',
      'manager.rename': '重命名',
      'manager.deleteGroup': '删除分组',
      'manager.deleteGroupHint': '删除分组（自选标的保留）',
      'manager.confirmRemove': '确认',
      'manager.addPlaceholder': '输入代码/名称，加入当前范围',
      'manager.removeRow': '从自选移除',
      'manager.col.code': '代码',
      'manager.col.name': '名称',
      'manager.col.market': '市场',
      'manager.col.groups': '分组',
      ...
      'quote.sendMenuFunding': '资金面快照（衍生品指标）',
      'quote.sendMenuOpen': '更多发送内容',
      'quote.sendFundingHint': '把衍生品快照（费率/持仓量/多空比/基差）填入会话输入框，按资金面流程分析',
      'quote.tab.chart': '图表',
      'quote.tab.fundamentals': '基本面',
      'quote.tab.derivatives': '衍生品',
      'quote.tab.news': '新闻',
      'quote.tab.announcements': '公告',
      'quote.history.loading': '正在加载更早数据…',
      'quote.history.earliest': '已到达最早历史',
      'quote.history.unsupported': '该数据源不支持更早历史',
      'quote.history.failed': '更早数据加载失败，点击重试',
      'quote.history.capped': '已达本次会话回溯上限',
      'quote.history.recheck': '重新检查更早历史',
      'quote.history.aria': '图表历史加载状态',
      ...
      'news.source.eastmoneyFundAnnouncement': '基金公告',
      'news.source.eastmoney': '东方财富',
      'news.source.eastmoneySymbolNews': '东财个股新闻',
      ...
      'trade.holdings.import.guide': '请解析我接下来贴出的券商/交易所持仓截图，把其中的持仓用 holdings_stage 工具录入待确认区（只 stage 不 confirm，我会到资产面板确认入账）。要求：market 用 crypto/us/cn/hk 词汇；symbol 用连接器词汇（如 AAPL / 002714.SZ / BTCUSDT）；数字必须原样取自截图，不确定的字段缺省不编造；一张截图一个 account 名（我未说明时用截图里的券商名）。请等我贴图。',
      ...
      'trade.summary.realizedHint': '已实现盈亏：平仓回合 FIFO 撮合合计（当前仅模拟盘成交流水，模拟池 USD 折算基准币）；比例 = 已实现 ÷ 平仓成本',
      ...
      'stage.macro': '宏观',
      'files.open': '文件',
      'flash.searchPlaceholder': '关键词（黄金 / 美联储 / 非农 …）',
      'flash.search': '搜索',
      'flash.clear': '清除',
      'flash.refresh': '刷新',
      'flash.loadMore': '加载更多',
      'flash.empty': '暂无快讯。',
      'flash.loading': '加载中…',
      'flash.error': '快讯数据源不可用：请在「设置 → 交易 → 市场快讯数据源」配置金十 MCP Token，或确认已安装金十连接器。',
      'flash.close': '关闭',
      'flash.heatTitle': '热度筛选',
      'flash.heatMulti': '可多选',
      'flash.heatAll': '全选',
      'flash.heatReset': '恢复默认',
      'macro.tab.calendar': '经济数据',
      'macro.tab.rates': '央行利率',
      'macro.regionG3': '美日中',
      'macro.regionAll': '全部',
      'macro.weekHint': '本周（北京时间）',
      'macro.col.actual': '公布',
      'macro.col.consensus': '预期',
      'macro.col.previous': '前值',
      'macro.col.revised': '修正',
      'macro.col.rateDate': '公布于',
      'macro.loading': '加载中…',
      'macro.empty': '暂无数据。',
      'macro.error': '宏观/利率数据源不可用：请确认已安装并启用金十数据连接器。',
...
export const en: Record<MarketLocaleKey, string> = {
      ...
      'tab.futures': 'Futures',
      'tab.global': 'Global',
      'index.spotGold': 'Spot gold',
      'index.wtiOil': 'WTI crude',
      'sidebar.addPlaceholder': 'Symbol, Enter to add',
      'sidebar.add': 'Add',
      'sidebar.addMarketHint': 'Click to cycle target market (crypto→us→cn→hk→futures)',
      ...
      'row.group': 'Group',
      'group.menu.aria': 'Watchlist groups',
      'group.all': 'All',
      'group.create': 'New Group',
      'group.createPlaceholder': 'Group name, Enter to confirm',
      'group.manage': 'Manage Watchlist',
      'group.emptyHint': 'No symbols in this group yet — add a code above or organize in Manage Watchlist',
      'group.duplicateName': 'Group name already exists',
      'group.notFound': 'Group no longer exists (it may have been deleted)',
      'group.createFailed': 'Failed — host bridge unavailable, nothing changed locally',
      'group.ungrouped': 'Ungrouped',
      'group.remove': 'Remove from Group',
      'group.noneHint': 'No groups yet — create one from the header menu',
      'manager.title': 'Manage Watchlist',
      'manager.close': 'Close',
      'manager.cancel': 'Cancel',
      'manager.ok': 'OK',
      'manager.rename': 'Rename',
      'manager.deleteGroup': 'Delete Group',
      'manager.deleteGroupHint': 'Delete group (symbols are kept)',
      'manager.confirmRemove': 'Confirm',
      'manager.addPlaceholder': 'Search code or name to add',
      'manager.removeRow': 'Remove from Watchlist',
      'manager.col.code': 'Code',
      'manager.col.name': 'Name',
      'manager.col.market': 'Market',
      'manager.col.groups': 'Groups',
      ...
      'quote.sendMenuFunding': 'Funding snapshot (perp metrics)',
      'quote.sendMenuOpen': 'More content to send',
      'quote.sendFundingHint': 'Fill the derivatives snapshot (funding / OI / long-short / basis) into the composer for flow analysis',
      ...
      'quote.history.loading': 'Loading earlier data…',
      'quote.history.earliest': 'Earliest history reached',
      'quote.history.unsupported': 'This data source does not support earlier history',
      'quote.history.failed': 'Failed to load earlier data · Retry',
      'quote.history.capped': 'Session history limit reached',
      'quote.history.recheck': 'Recheck earlier history',
      'quote.history.aria': 'Chart history loading status',
      ...
      'news.source.eastmoneyFundAnnouncement': 'Fund filings',
      'news.source.eastmoney': 'Eastmoney',
      'news.source.eastmoneySymbolNews': 'Eastmoney symbol news',
      ...
      'trade.holdings.import.guide': 'Please parse the broker/exchange holdings screenshot I am about to paste, and stage the positions via the holdings_stage tool (stage only, do not confirm — I will review them in the assets panel). Requirements: use market vocabulary crypto/us/cn/hk; use connector symbols (e.g. AAPL / 002714.SZ / BTCUSDT); copy numbers exactly as shown in the screenshot and leave uncertain fields unset (never invent values); one screenshot = one account name (use the broker name shown in the screenshot if I did not specify). Please wait for my screenshot.',
      ...
      'trade.summary.realizedHint': 'Realized P&L: FIFO-matched closed rounds (paper fills only for now, demo-pool USD converted to base); ratio = realized ÷ closed cost',
      ...
      'entry.update': 'Software updates',
      'entry.updateAvailable': 'Update available',
      ...
      'stage.macro': 'Macro',
      'files.open': 'Files',
      'flash.searchPlaceholder': 'Keyword (gold / Fed / payrolls …)',
      'flash.search': 'Search',
      'flash.clear': 'Clear',
      'flash.refresh': 'Refresh',
      'flash.loadMore': 'Load more',
      'flash.empty': 'No flash items yet.',
      'flash.loading': 'Loading…',
      'flash.error': 'Flash source unavailable: set the Jin10 MCP token in Settings → Trading → Market flash data source, or check that the Jin10 connector is installed.',
      'flash.close': 'Close',
      'flash.heatTitle': 'Heat filter',
      'flash.heatMulti': 'multi-select',
      'flash.heatAll': 'All',
      'flash.heatReset': 'Defaults',
      'macro.tab.calendar': 'Economic data',
      'macro.tab.rates': 'Central bank rates',
      'macro.regionG3': 'US/JP/CN',
      'macro.regionAll': 'All regions',
      'macro.weekHint': 'This week (Beijing time)',
      'macro.col.actual': 'Actual',
      'macro.col.consensus': 'Consensus',
      'macro.col.previous': 'Previous',
      'macro.col.revised': 'Revised',
      'macro.col.rateDate': 'Effective',
      'macro.loading': 'Loading…',
      'macro.empty': 'No data.',
      'macro.error': 'Macro/rates source unavailable: check that the Jin10 data connector is installed and enabled.',
