...
"@dshtrading/api": minor
"@dshtrading/router": minor
"@dshtrading/base": minor
"@dshtrading/client-ui-trading": minor
"@dshtrading/client-ui-settings": minor
---

金十数据接入面扩展：设置卡片 + GUI 快讯面板 + `global` 市场数据面（行情接市场路由）。
